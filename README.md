...
| **Maps (`tiledmap`)** — named-location & lat/long | region-map (`regionType`) / point-map (lat/long/size) | ✅ |
| Cognos network / word-cloud / packed-bubble / treemap (no native Sigma element) | flagged → table fallback | ⚠ flagged |
